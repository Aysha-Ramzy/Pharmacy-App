                ...
                <div className="lg:w-1/3 w-full">
                    <div className="p-10">
                        <div className="mb-10 flex items-center justify-between">
                            ...
                            <button className="bg-purple-700 text-white px-3 py-1.5 rounded" onClick={openModal}>Add Item</button>
                        </div>
                        <div className="">
                            {items.length > 0 ? items.map((item, key) => <EachItem key={key} item={item} fetchData={fetchData} />) : ''}
                        </div>
                            ...
                            <div className="fixed z-10 inset-0 overflow-y-auto">
                                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                    ...
                                    <div className="relative inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg w-full">
                                        <form id="newform" onSubmit={storeItem} method="post">
                                            <div className="bg-white">
                                                ...
                                                <div className="px-8 py-8">
                                                    ...
                                                    <div className="mb-5">
                                                        ...
                                                        <input type="text" name="category" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required />
                                                    </div>
                                                    <div className="mb-10">
                                                        <label className="block text-gray-700 text-sm font-bold mb-2">UnitPrice(LKR)</label>
                                                        <input type="number" name="unitprice" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required />
                                                    </div>
